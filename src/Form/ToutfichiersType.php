...
{   public function __construct(SessionInterface $session)
    ...
    {       
        ...
        switch ($options['data']['choix']) {
              case '0':       $choice=[ 'Mémoire(pdf, 2,5 M max, 20 pages)'=>0];
              
                  break;   
              case '1':       $choice= ['Annexe(pdf, 2,5 M max, 20 pages)'=>1];
              
                  break;   
              case '2':       $choice=['Résumé(pdf, 1 M max, 1 page)'=>2];
              
                  break;   
             
              case '3':       $choice=  [ 'Diaporama  pour le jury(pdf, 10 M maxi)et qui sera publiée après le concours'=>3];
              
                  break;   
               case '4':       $choice=  ['Fiche sécurité(1M max, doc, docx, pdf, jpg, odt)'=>4];
              
                  break;   
               case '5':       $choice=  ['Diaporama  pour le jury(pdf, 10 M maxi)'=>5];
