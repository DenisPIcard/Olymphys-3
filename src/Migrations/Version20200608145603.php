 ...
 */
final class Version20200608145603 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE equipesadmin ADD centre_id INT DEFAULT NULL, DROP centrecia_id, CHANGE lettre lettre VARCHAR(1) DEFAULT NULL, CHANGE numero numero SMALLINT DEFAULT NULL, CHANGE selectionnee selectionnee TINYINT(1) DEFAULT NULL, CHANGE titreProjet titreProjet VARCHAR(255) DEFAULT NULL, CHANGE nom_lycee nom_lycee VARCHAR(255) DEFAULT NULL, CHANGE denomination_lycee denomination_lycee VARCHAR(255) DEFAULT NULL, CHANGE lycee_localite lycee_localite VARCHAR(255) DEFAULT NULL, CHANGE lycee_academie lycee_academie VARCHAR(255) DEFAULT NULL, CHANGE id_prof1 id_prof1 INT DEFAULT NULL, CHANGE id_prof2 id_prof2 INT DEFAULT NULL, CHANGE prenom_prof1 prenom_prof1 VARCHAR(255) DEFAULT NULL, CHANGE nom_prof1 nom_prof1 VARCHAR(255) DEFAULT NULL, CHANGE prenom_prof2 prenom_prof2 VARCHAR(255) DEFAULT NULL, CHANGE nom_prof2 nom_prof2 VARCHAR(255) DEFAULT NULL, CHANGE rne rne VARCHAR(255) DEFAULT NULL, CHANGE rne_id rne_id INT DEFAULT NULL, CHANGE edition_id edition_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE equipesadmin ADD CONSTRAINT FK_A26C5EB1463CD7C3 FOREIGN KEY (centre_id) REFERENCES centrescia (id)');
        ...
        $this->addSql('CREATE INDEX IDX_A26C5EB1463CD7C3 ON equipesadmin (centre_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE equipesadmin DROP FOREIGN KEY FK_A26C5EB1463CD7C3');
