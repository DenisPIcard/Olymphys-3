...
class DashboardController extends AbstractDashboardController
{
    ...
    public function configureMenuItems(): iterable
    {
        ...
        $submenu2 = [
            ...
            MenuItem::linkToCrud('Les vidéos des équipes', 'fas fa-film', Videosequipes::class),
            MenuItem::linkToCrud('Les photos', 'fas fa-images', Photos::class),
            MenuItem::section('Les livres d\'or'),
            MenuItem::linkToCrud('Livre d\'or des élèves', 'fas fa-book', Livredor::class),
            MenuItem::linkToCrud('Livre d\'or des professeurs', 'fas fa-book', Livredor::class),
            MenuItem::linkToCrud('Livre d\'or du jury', 'fas fa-book', Livredor::class),
            MenuItem::linkToCrud('Livre d\'or du comité', 'fas fa-book', Livredor::class),
        ...
        yield MenuItem::linkToCrud('Les equipes inscrites', 'fas fa-user-friends', Equipesadmin::class);
        yield MenuItem::linkToCrud('Professeurs', 'fas fa-fas fa-user-tie', Professeurs::class);
        yield MenuItem::linkToCrud('Eleves', 'fas fa-fas fa-child', Elevesinter::class);
        yield MenuItem::linkToCrud('Etablissements avec équipes', 'fas fa-fas fa-building', Equipesadmin::class);
